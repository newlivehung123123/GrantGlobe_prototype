...
CONNECTORS = [
    ...
    ("Tāwhia te Mana (NZ)",    CONNECTORS_DIR / "newzealand_tawhia_te_mana.py"),
    ("IBS (Korea)",            CONNECTORS_DIR / "korea_ibs.py"),
    ("Korea Foundation",       CONNECTORS_DIR / "korea_foundation.py"),
    ("NSFC (China)",           CONNECTORS_DIR / "china_nsfc.py"),
    ("CAS PIFI (China)",       CONNECTORS_DIR / "china_cas_pifi.py"),
    ("Tsinghua Shuimu Scholar Program (China)", CONNECTORS_DIR / "china_tsinghua.py"),
    ("PKU Boya Postdoctoral Fellowship (China)", CONNECTORS_DIR / "china_pku_boya.py"),
    ("Westlake Fellows Program (China)", CONNECTORS_DIR / "china_westlake.py"),
    ("RGC Hong Kong",          CONNECTORS_DIR / "hongkong_rgc.py"),
    ("HKU Society of Fellows", CONNECTORS_DIR / "hongkong_hku.py"),
    ("CUHK RIH Postdoctoral Fellowship", CONNECTORS_DIR / "hongkong_cuhk.py"),
    ("Academia Sinica (Taiwan)", CONNECTORS_DIR / "taiwan_academia_sinica.py"),
    ("Taiwan Fellowship (MOFA)", CONNECTORS_DIR / "taiwan_fellowship_mofa.py"),
